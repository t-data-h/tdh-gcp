...
# distribute
echo "Running Ansible Playbooks : tdh-distribute, tdh_install --tags tdh-config"
...
# install
echo "( ansible-playbook -i inventory/tdh-west1/hosts --tags tdh-config tdh-install.yml )"
if [[ $ACTION == "run" ]]; then
